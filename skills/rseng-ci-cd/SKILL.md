...
- `references/pages/<page_id>.md` -- cleaned upstream RSQKit fragments for
...
- `references/indicators.md` -- the quality-indicator checklist to apply
  when reviewing a project's CI/CD setup.
- `references/learn-more.md` -- verified external pointers; draw any links
...
`references/learn-more.md`, proportionate to the question and never a
lecture.
