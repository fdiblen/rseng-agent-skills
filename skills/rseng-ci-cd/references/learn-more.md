...
- https://docs.gitlab.com/ee/user/project/repository/mirror/#mirror-only-protected-branches
...
- https://docs.gitlab.com/ee/user/project/members/#add-users-to-a-project
...
- https://zenodo.org/records/14643958
