<!-- Generated file - do not edit.
     Source: pages/tasks/licensing_software.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/licensing_software),
...
* [Choose an open source license](https://choosealicense.com/) is a great tool to help you choose a license that is appropriate for your needs.
* [SPDX](https://spdx.org/licenses/) (System Package Data Exchange - open standard project) provides a long list of [commonly used licenses][spdx-licences].
...
* In case you want or need to apply licenses one a per file bases, have a look at [REUSE](https://reuse.software/).
