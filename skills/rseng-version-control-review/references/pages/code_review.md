<!-- Generated file - do not edit.
     Source: pages/tasks/code_review.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/code_review),
...
- [GitHub](https://github.com/) and [GitLab](https://about.gitlab.com/) have built-in review tools for code review discussions and suggestions
- [Code Linters](https://en.wikipedia.org/wiki/Lint_%28software%29) (e.g., flake8, eslint, [Pylint](https://pylint.readthedocs.io/en/stable/)) ensure code style consistency
- [CI pipelines](https://everse.software/RSQKit/ci_cd) automatically run tests and checks on submitted code
