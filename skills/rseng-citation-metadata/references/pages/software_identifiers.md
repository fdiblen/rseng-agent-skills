<!-- Generated file - do not edit.
     Source: pages/tasks/software_identifiers.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/software_identifiers),
...
- [Semantic Versioning](https://semver.org/) - a structured approach to versioning software in the format MAJOR.MINOR.PATCH.
...
We will explore how you can do that for your software using [Zenodo](https://zenodo.org/), a general-purpose open archive and publishing repository developed under the European OpenAIRE program and operated by CERN.
...
* Provide software metadata in a CodeMeta file (`codemeta.json`) at the root of your software repository. See more on [software metadata](https://everse.software/RSQKit/software_metadata) and [CodeMeta](https://codemeta.github.io/) standard.
...
* Add the [eOSSR](https://gitlab.com/escape-ossr/eossr) or the [gitlab2zenodo](https://gitlab.com/sbeniamine/gitlab2zenodo) libraries in  your [GitLab-CI pipeline](https://docs.gitlab.com/ee/ci/yaml/) to automatically archive your code on Zenodo whenever you create a new release.
...
![Badge in Zenodo](https://everse.software/RSQKit/images/badge_zenodo.png)
...
![Badge in a software repository](https://everse.software/RSQKit/images/badge_in_repo.png)
