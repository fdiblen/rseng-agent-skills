<!-- Generated file - do not edit.
     Source: pages/roles/researcher_who_codes.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/researcher_who_codes),
...
- When projects grow more complex, researchers who code often benefit from working with [RSEs](https://everse.software/RSQKit/research_software_engineer) to improve code quality, scalability, and reusability.
...
- [Software project structure](https://everse.software/RSQKit/software_project_structure) - a well-structured project directory facilitates collaboration, maintenance and reproducibility
- [Adopting FAIR principles](https://everse.software/RSQKit/fair_rs) promotes transparency and facilitates wider adoption of research software
- Code quality best practices - [version control](https://everse.software/RSQKit/using_version_control), [testing](https://everse.software/RSQKit/testing_software), [documentation](https://everse.software/RSQKit/documenting_software) and [licensing](https://everse.software/RSQKit/licensing_software)
- [Software testing practices](https://everse.software/RSQKit/testing_software) and automating tests using [Continuous Integration](https://everse.software/RSQKit/ci_cd) (CI)
- Engaging in [code reviews](https://everse.software/RSQKit/code_review) - regular code reviews contribute to code quality and facilitate knowledge sharing among team members.
