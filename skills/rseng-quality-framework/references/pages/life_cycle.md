<!-- Generated file - do not edit.
     Source: pages/research_software_and_quality/life_cycle.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/life_cycle),
...
<!-- ![Research software lifecycle diagram](https://everse.software/RSQKit/images/rs-lifecycle.png) --> <p align="center"><img src="./images/rs-lifecycle.svg" width="600" alt-text="Research software lifecycle" /></p>
...
Please see the RSQKit [Software Management Planning](https://everse.software/RSQKit/software_management_planning) page for more information about them.
...
There is a close link between this software lifecycle and the [three-tier model of software](https://everse.software/RSQKit/three_tier_view).
...
[ci_cd]: https://everse.software/RSQKit/ci_cd
...
[packaging_software]: https://everse.software/RSQKit/packaging_software
