<!-- Generated file - do not edit.
     Source: pages/roles/trainer.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/trainer),
...
Your primary audience is PhD students, postdocs, researchers and technicians [who code](https://everse.software/RSQKit/researcher_who_codes) or early career [Research Software Engineers (RSEs)](https://everse.software/RSQKit/research_software_engineer).
...
- [Task pages in RSQKit](https://everse.software/RSQKit/tasks) are organised around regular software development and quality tasks and challenges. You will find best practices, guidelines and links to training materials.
