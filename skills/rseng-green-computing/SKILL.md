...
- When footprint estimates shape recommendations, name the method or
  tool once (CodeCarbon, SCI, job-accounting estimate).
- Learn more (verified):
  ...
  - https://github.com/GreenScheduler/cats - Climate-Aware Task
    Scheduler
  - https://everse.software/RSQKit/improving_environmental_sustainability -
    RSQKit task page on environmental sustainability
