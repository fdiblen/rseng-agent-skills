<!-- Generated file - do not edit.
     Source: pages/tasks/fair_rs.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/fair_rs),
...
- Use standards (such as [CodeMeta](https://codemeta.github.io/)) to describe interoperable metadata for your software (see [Research Software Metadata Guidelines][rsmd-g1])
...
- Use a unique and persistent identifiers for your software, such as **Digital Object Identifiers** (DOIs) provided by [Zenodo](https://zenodo.org/), [FigShare](https://figshare.com/), or **SoftWare Heritage persistent IDentifiers** ([SWHID](https://everse.software/RSQKit/swhid)) provided by [Software Heritage](https://www.softwareheritage.org).
...
- More broadly, use software sharing and collaborative platforms, as they facilitate code publication, sharing and findability:
  - general-purpose software repositories - [GitHub](https://github.com/) and [GitLab](https://about.gitlab.com/)
  - programming language-specific software repositories - [Python Package Index (PyPi)](https://pypi.org/) (for [Python](https://www.python.org/)) and [CRAN](https://cran.r-project.org/) (for R)
  - software registries - [bio.tools](https://bio.tools/) (for biosciences) and [Awesome Research Software Registries][awesome-rs-registries], providing a list of research software registries (by country, organisation, domain and programming language) where research software can be registered to help promote its discovery
...
- Use community-agreed standard formats for inputs and outputs of [your software and its metadata][software_metadata] (e.g. [CodeMeta](https://codemeta.github.io/))
...
- [Give a licence to your software][licensing_software] clearly stating how it can be reused (check the [open source licence guide][opensource-licence-guide] or [Choose an open source license](https://choosealicense.com/) on choosing the licence most appropriate for your needs)
...
- [FAIR software checklist](https://fairsoftwarechecklist.net) - a self-assessment tool developed by the Australian Research Data Commons (ARDC) and the Netherlands eScience Center
- [FAIRsoft Evaluator](https://openebench.bsc.es/observatory/Evaluation) - OpenBench's tool for assessing the FAIRness of software tool from its metadata
- [howfairis](https://github.com/fair-software/howfairis) - a command line tool to evaluate a software repository's compliance with the FAIR principles
- [CODECHECK](https://codecheck.org.uk/) - an approach for independent execution of computations underlying research articles
- [Common metrics for Research Software][fair-metrics] that may used to assess each of the FAIR4RS principles
- [Research Software FAIRness Checks](https://rsfc.linkeddata.es) - a command line interface to automatically evaluate the FAIRness of a Github or Gitlab repository
...
[rs-quality]: https://everse.software/RSQKit/quality
[fair-metrics]: https://doi.org/10.5281/zenodo.15535629
[software_metadata]: https://everse.software/RSQKit/software_metadata
[software_documentation]: https://everse.software/RSQKit/software_documentation
[licensing_software]: https://everse.software/RSQKit/licensing_software
[documenting_code]: https://everse.software/RSQKit/documenting_code
[archiving_software.md]: https://everse.software/RSQKit/archiving_software
[testing_software]: https://everse.software/RSQKit/testing_software
[citing_software]: https://everse.software/RSQKit/citing_software
[software_project_structure]: https://everse.software/RSQKit/software_project_structure
