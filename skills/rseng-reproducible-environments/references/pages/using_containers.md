<!-- Generated file - do not edit.
     Source: pages/tasks/using_containers.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/using_containers),
...
[Docker](https://www.docker.com/): is ideal for general-purpose development and cloud deployment.
...
[Apptainer](https://apptainer.org/): (formerly Singularity) is better suited for HPC environments where users lack root access.
