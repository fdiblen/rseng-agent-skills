<!-- Generated file - do not edit.
     Source: pages/tasks/writing_research_software_stories.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/writing_research_software_stories),
...
It can highlight where additional [RSQKit tasks](https://everse.software/RSQKit/tasks) might be useful and help teams think about how their software could be made more sustainable over time.
...
A collection of example Research Software Stories is available [within RSQKit](https://everse.software/RSQKit/research_software_stories) and can provide useful reference points when writing a new one.
