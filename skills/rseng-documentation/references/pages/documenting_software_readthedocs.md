<!-- Generated file - do not edit.
     Source: pages/tasks/documenting_software_readthedocs.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/documenting_software_readthedocs),
...
Typically, this documentation is composed of static pages generated by tools such as [Sphinx](https://www.sphinx-doc.org) or [MKDocs](https://www.mkdocs.org/).
Platforms like [GitHub](https://github.com/) or [GitLab](https://about.gitlab.com/) offer features to host static documentation, but a popular alternative is [Read the Docs](https://about.readthedocs.com/), which simplifies publishing and managing documentation.
...
* [Sphinx](https://www.sphinx-doc.org): run `sphinx-quickstart` to initialise the project. This will create configuration files and folder structure for your documentation.
* [MKDocs](https://www.mkdocs.org/): Install MkDocs and run `mkdocs new my-project` to create a basic structure with Markdown files.
...
* [GitHub Actions](https://github.com/features/actions): set up a workflow that triggers on every `push` or `pull request`. This helps automate the process of updating the documentation whenever you make changes to the source files.

* [GitLab CI/CD](https://docs.gitlab.com/ee/topics/build_your_application.html): similarly to GitHub, you can configure GitLab CI pipelines to handle automatic updates.
