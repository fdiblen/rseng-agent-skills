<!-- Generated file - do not edit.
     Source: pages/tasks/creating_good_readme.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/creating_good_readme),
...
For example, in [Python](https://www.python.org/) by using the requirements.txt file.

This is a non exhaustive list of requirements categories that you can consider:

- Operating system version
- Operating system libraries version
- Version of the interpreter (e.g. [Python](https://www.python.org/) 3.9, [Java](https://www.java.com/en/) 7, etc.)
...
If you have multiple options for installing the software (e.g. installing a library, [Docker](https://www.docker.com/), script) you should describe them.
...
You can see a list of them used to make your project more fair in [howfairis](https://github.com/fair-software/howfairis).
...
[SOMEF](https://github.com/KnowledgeCaptureAndDiscovery/somef) is a [tool to automatically extract information (metadata) from README files][somef-paper].
