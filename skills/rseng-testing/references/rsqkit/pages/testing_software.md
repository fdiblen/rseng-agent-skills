<!-- Generated file - do not edit.
     Source: pages/tasks/testing_software.md @ 03a8352e0701acf6ae28a1f6c9069e9b2caf8e7e
     From RSQKit (the Research Software Quality Kit) by the EVERSE project and the RSQKit team (https://everse.software/RSQKit/testing_software),
...
Automated testing involves using special testing frameworks (e.g. [testthat](https://testthat.r-lib.org/) for R, [Pytest](https://docs.pytest.org/en/latest/) for Python, [JUnit](https://junit.org/junit5/) for Java, [Test.jl](https://docs.julialang.org/en/v1/stdlib/Test/) module for Julia) to automate and control the execution of tests (which is software separate from the software being tested) and the comparison of actual with predicted outcomes.
...
Popular examples of CI infrastructures include [GitHub Actions](https://github.com/features/actions) and [GitLab CI/CD](https://docs.gitlab.com/ee/topics/build_your_application.html).
