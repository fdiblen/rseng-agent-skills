...
59 skills covering the practices that make research software good -
...
|---|---|---|
| Claude Code | 59 skills, /rseng-check, /rseng-cite, /rseng-plan, rseng-auditor agent | `/plugin marketplace add <owner>/rseng-agent-skills` then `/plugin install rseng-agent-skills` |
